...
- YYYY --> the assigned RFC number for {{!I-D.ietf-ccamp-otn-topo-yang}}

- ZZZZ --> the assigned RFC number for {{!I-D.ietf-ccamp-layer1-types}}

- VVVV --> the assigned RFC number for {{!I-D.ietf-teas-ietf-network-slice-nbi-yang}}

- WWWW --> the assigned RFC number for {{!I-D.ietf-teas-network-slice-topology-yang}}

Please replace the revision date of the latest revision of the 'ietf-otn-slice-mpi' and of the 'ietf-otn-slice' modules with the publication date of this I-D, using the the format (year-month-day).
...
| otns     | ietf-otn-slice               | RFC XXXX
| otns-mpi | ietf-otn-slice-mpi           | RFC XXXX
